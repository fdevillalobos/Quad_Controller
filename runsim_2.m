function error = runsim_2(x_kp,y_kp,z_kp,x_kd,y_kd,z_kd)
...
params = nanoplus_2(x_kp,y_kp,z_kp,x_kd,y_kd,z_kd);
...
%         end
        ...
        [~, error] = quadEOM_2(time, x{qn}, qn, controlhandle, trajhandle, params);
        x{qn}    = xsave(end, :)';
