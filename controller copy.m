function [F, M, trpy, drpy, error] = controller(qd, t, qn, params)
...
% end
%F    = params.mass * (params.grav - kd*qd{qn}.vel(3) - kp*(qd{qn}.pos(3) - qd{qn}.pos_des(3)));


% Desired roll, pitch and yaw
% phi_des   = 1/params.grav* (qd{qn}.acc_des(1)*sin(qd{qn}.yaw_des) - qd{qn}.acc_des(2)*cos(qd{qn}.yaw_des));
% theta_des = 1/params.grav* (qd{qn}.acc_des(1)*cos(qd{qn}.yaw_des) + qd{qn}.acc_des(2)*sin(qd{qn}.yaw_des));
...
kp_psi   = 10;     kd_psi   = 1;
p_des    =  0;     q_des    = 0;     r_des = qd{qn}.yawdot_des; % = 0.
